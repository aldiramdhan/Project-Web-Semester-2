...
Route::get('/kategori', [HomeController::class,'category'])->name('home.kategori');
Route::get('/buku', [HomeController::class,'book'])->name('home.buku');
Route::get('/tentang', [HomeController::class,'about'])->name('home.tentang');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/detail-book/{slug}', [BookController::class, 'detail'])->name('detail-book');
    Route::post('/detail-book/store', [BookRentController::class, 'store'])->name('detail-book.store');
